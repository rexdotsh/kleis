...
CREATE TABLE `__new_request_usage_buckets` (
...
INSERT INTO `__new_request_usage_buckets`("bucket_start", "api_key_id", "provider_account_id", "provider", "endpoint", "model", "request_count", "success_count", "client_error_count", "server_error_count", "auth_error_count", "rate_limit_count", "total_latency_ms", "max_latency_ms", "input_tokens", "output_tokens", "cache_read_tokens", "cache_write_tokens", "last_request_at")
SELECT
	"bucket_start",
	"api_key_id",
	"provider_account_id",
	...
	"last_request_at"
FROM `request_usage_buckets`;--> statement-breakpoint
DROP TABLE `request_usage_buckets`;--> statement-breakpoint
ALTER TABLE `__new_request_usage_buckets` RENAME TO `request_usage_buckets`;--> statement-breakpoint
